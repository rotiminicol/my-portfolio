            ...
            <div className='contact-content'>
                ...
                <div className='contact-info'>
                    <div className="contact-card">
                        ...
                        <span className='contact-card-data'>rotiminicol117@gmail.com</span>

                        <a href="mailto:rotiminicol117@gmail.com" 
                        className='contact-button'>
                            Write me{" "}
                            <i className='bx bx-right-arrow-alt 
                            contact-button-icon'></i></a>
                    </div>
                    ...
                    <div className="contact-card">
                        ...
                        <span className='contact-card-data'>+234 9055143532</span>
                    ...
                    <div className="contact-card"> 
                        ...
                        <span className='contact-card-data'>Rotimi117</span>

                        <a href="https://m.me/cyrpticalcoder" 
                        className='contact-button'>
                            Write me
                            <i className='bx bx-right-arrow-alt 
                            contact-button-icon'></i></a>
